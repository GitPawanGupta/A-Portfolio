...
const Experience = () => {
  ...
  return (
    <section className="glass-effect rounded-xl sm:rounded-2xl shadow-premium p-6 sm:p-8 lg:p-10 mb-6 sm:mb-8 lg:mb-10 hover-lift border border-white/50 relative overflow-hidden">
      ...
      <div className="relative pl-4 sm:pl-6 lg:pl-8 border-l-2 border-gradient-to-b from-blue-500 to-purple-500">
        ...
        <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-800 mb-2">
          Legal Associate – Litigation & Legal Advisory
        </h3>
        <p className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 font-semibold mb-2 text-sm sm:text-base">
          Under Advocate Sumit Jain – Delhi High Court & Karkardooma Court
        </p>
        <p className="text-gray-500 mb-4 sm:mb-6 font-medium text-sm sm:text-base">December 2022 – Present (July 2025)</p>
